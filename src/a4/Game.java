...
public class Game extends JFrame implements ActionListener, MouseListener, MouseMotionListener,MouseWheelListener{
...
//				buttonPanel.add(tickButton);
	...
	public void mousePressed(MouseEvent e) {
		...
		Point2D.Float point = new Point2D.Float((float)e.getPoint().getX(), (float)e.getPoint().getY());
		try{
			mv.getVTM().inverseTransform(point, point);
